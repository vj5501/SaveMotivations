...
export default class Post extends Component {
  ...
  <input onChange={this.handleChange} type="text" className="form-control bg-dark text-light fs-5" id="exampleFormControlTextarea1" rows="3" name="quote" value={this.state.value} placeholder="Type you're Motivation ... " style={{height:'150px'}}/>
</div>
